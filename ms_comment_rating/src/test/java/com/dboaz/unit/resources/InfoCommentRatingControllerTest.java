...
import com.dboaz.resources.InfoCommentRatingController;
import com.dboaz.utils.models.GlobalInfo;

@ActiveProfiles("test")
@WebMvcTest(InfoCommentRatingController.class)
class InfoCommentRatingControllerTest {

    @Autowired MockMvc mockMvc;

    @Value("${microservice.ms_comment_rating.name}") String name;
    @Value("${microservice.ms_comment_rating.version}") String version;
    @Value("${microservice.ms_comment_rating.description}") String description;

    @MockBean InfoCommentRatingController controller;
