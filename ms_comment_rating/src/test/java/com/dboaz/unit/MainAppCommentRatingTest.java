...
import com.dboaz.MainAppCommentRating;
import com.dboaz.properties.ApplicationProperties;

import org.junit.jupiter.api.Test;

class MainAppCommentRatingTest {
    private static final Logger LOGGER = LogManager.getLogger(MainAppCommentRatingTest.class);
    ...
    public void testMainMethodExists() {
        ...
        assertTrue(hasMainMethod(MainAppCommentRating.class), "O método main não foi encontrado na classe MainAppCommentRating");
