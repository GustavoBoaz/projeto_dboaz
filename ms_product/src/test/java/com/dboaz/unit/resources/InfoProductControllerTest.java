...
import com.dboaz.resources.InfoProductController;
import com.dboaz.utils.models.GlobalInfo;

@ActiveProfiles("test")
@WebMvcTest(InfoProductController.class)
class InfoProductControllerTest {
    ...
    @MockBean InfoProductController controller;
