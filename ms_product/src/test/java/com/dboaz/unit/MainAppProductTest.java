...
class MainAppProductTest {
    private static final Logger LOGGER = LogManager.getLogger(MainAppProductTest.class);
    ...
    void testMainMethodExists() {
        ...
        assertTrue(hasMainMethod(MainAppProduct.class), "O método main não foi encontrado na classe MainAppProduct");
