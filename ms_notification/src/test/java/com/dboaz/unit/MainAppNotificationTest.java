...
class MainAppNotificationTest {
    private static final Logger LOGGER = LogManager.getLogger(MainAppNotificationTest.class);
    ...
    void testMainMethodExists() {
        ...
        assertTrue(hasMainMethod(MainAppNotification.class), "O método main não foi encontrado na classe MainAppNotification");
