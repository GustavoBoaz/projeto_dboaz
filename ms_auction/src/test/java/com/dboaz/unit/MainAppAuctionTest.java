...
class MainAppAuctionTest {
    private static final Logger LOGGER = LogManager.getLogger(MainAppAuctionTest.class);
    ...
    public void testMainMethodExists() {
        ...
        assertTrue(hasMainMethod(MainAppAuction.class), "O método main não foi encontrado na classe MainAppAuction");
